...
#define LED_BUILTIN 15   // labeled d8 on the board
...
char auth[] = "fVQ67FcP5qthZaDWPU5jeyO-BAak53eC"; // dbm 11 NOV 2020
...
void setup()
{
  ...
  Serial.println("Blynk.begin in");
  Blynk.begin(auth, ssid, pass);
  Serial.println("Blynk.begin out");
